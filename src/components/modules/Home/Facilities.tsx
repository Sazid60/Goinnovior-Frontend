        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8 lg:gap-6 justify-between -mt-10 lg:-mt-20 mb-6">
          {serviceSteps.slice(0, 4).map((step) => (
            ...
            >
              ...
              <div className="absolute -top-5 left-1/2 -translate-x-1/2 z-10 flex items-center justify-center w-9 h-9 bg-white rounded-full shadow-md  text-base font-bold text-[#4d4d4d]">
                {step.number}
              </div>
