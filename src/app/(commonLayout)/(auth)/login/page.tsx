                    ...
                    <div className="w-full max-w-[320px] md:max-w-[420px] space-y-4">
                        ...
                        <div className="flex justify-center gap-4 mb-6 md:mb-10">
                            <SocialButton onClick={handleGoogleLogin}>
                                ...
                                <span className="ml-2 text-sm font-medium text-neutral-600">Continue with Google</span>
                            </SocialButton>
                        </div>
                    </div>
                </div>
...
const SocialButton = ({ children, onClick }: SocialButtonProps) => (
    <button
        onClick={onClick}
        className="w-full h-[45px] md:h-[50px] bg-white rounded-xl shadow-[0px_2px_8px_rgba(0,0,0,0.08)] flex items-center justify-center hover:bg-neutral-50 transition-all active:scale-95 border border-neutral-100"
    >
        {children}
    </button>
);
